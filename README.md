# nvim-treesitter-queries-cmake

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-cmake/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-cmake/actions/workflows/validate.yml)

Neovim tree-sitter queries for **cmake**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-cmake",
...
- [ ] Changes are scoped to `cmake` — do not include files for other languages
